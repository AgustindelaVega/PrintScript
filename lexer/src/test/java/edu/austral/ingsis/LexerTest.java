...
public class LexerTest {
    ...
    public void testLexerInvalidInput() {
        Lexer lexer = new PrintScriptLexer();
        Exception exception = assertThrows(LexerException.class, () -> lexer.lex("./src/test/resources/lexer_test03.txt"));
    ...
    public void testLexerInvalidInput2() {
        Lexer lexer = new PrintScriptLexer();
        Exception exception = assertThrows(LexerException.class, () -> lexer.lex("./src/test/resources/lexer_test04.txt"));
